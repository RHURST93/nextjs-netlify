...
const projects: Project[] = [
  {
    ...
    description:
      "A website for my wildlife photography. This site was built with React, utilizing Reactstrap and Lightbox.js. I used the gradient in the navbar to make it appear as the sun is peeking in at the corner of the screen. In the footer the leaves signify natural habitats. It felt like the right combonation. ",
  ...
  },
  {
    ...
    description:
      "This website showcases my mobile development skills with React Native. This task manager is just the start for this app. I plan to add many different features to help primarily with productivity throughout the day.",
