  ...
  return (
    <>
      <div>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-4 items-center">
            ...
            <div className="sm:order-2 md:order-2 lg:order-2 ">
              <p className=" mx-auto mt-4 text-justify sm:text-left xs:w-80 mr-5 px-3 text-wrap">
                ...
                the values instilled by my upbringing. Beyond the realms of
                technology, I find joy and solace in capturing the wonders of
                wildlife through photography, reveling in the tranquil beauty of
                nature's creations. Golfing under the open sky and the serenity
                of fishing in quiet waters are pursuits that bring me immense
                happiness and relaxation. Embracing both the technological
                advancements and the tranquility of nature, I find a harmonious
                balance that enriches my life.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <CAccordion activeItemKey={2}>
            ...
            <CAccordionItem itemKey={4}>
              <CAccordionHeader>Modern Software Development</CAccordionHeader>
              <CAccordionBody>
                <table className="table-auto w-full border-collapse border border-gray-300 mr-5">
                  <thead>
                    <tr className="bg-blue-300">
                ...
                <CListGroup>
                  ...
                  <CListGroupItem>
                    <Image
                      src={require("../../img/kubernetes.png")}
                      alt="kubernetes logo"
                      className="w-6 h-6 mr-2 inline-block"
                    />
                    Kubernetes
        ...
        >
          <table
            className="table-auto w-full border-collapse border border-gray-300 mr-5 "
            width={200}
          >
            <thead>
              <tr className="bg-blue-300">
            ...
            <tbody>
              <tr className="bg-white">
                ...
                <td className="px-4 py-2 border">
                  {calculateExperience("2023-08-01")} months
                </td>
              </tr>
              <tr className="bg-white">
                <td className="px-4 py-2 border">
                ...
                <td className="px-4 py-2 border">
                  {calculateExperience("2023-07-01")} months
                </td>
              </tr>
              <tr className="bg-white">
                <td className="px-4 py-2 border">
                ...
                <td className="px-4 py-2 border">
                  {calculateExperience("2023-09-01")} months
                </td>
              </tr>
              <tr className="bg-white">
                <td className="px-4 py-2 border">
                ...
                <td className="px-4 py-2 border">
                  {calculateExperience("2023-10-01")} months
                </td>
              </tr>
              <tr className="bg-white">
                <td className="px-4 py-2 border">
                ...
                <td className="px-4 py-2 border">
                  {calculateExperience("2023-11-01")} months
                </td>
              </tr>
              <tr className="bg-white">
                <td className="px-4 py-2 border">
                  <Image
                    src={require("../../img/nextlogo.png")}
                    alt="next js logo"
                    className="w-6 h-6 mr-2 inline-block"
                  />
                  Next JS
              ...
              <tr className="bg-white">
                ...
                <td className="px-4 py-2 border">
                  {calculateExperience("2024-12-15")} months
                </td>
              </tr>
              <tr className="bg-white">
                <td className="px-4 py-2 border">
                  <Image
                    src={require("../../img/postgres.png")}
                    alt="postgres logo"
                    className="w-6 h-6 mr-2 inline-block"
                  />{" "}
                  PostgreSQL
                ...
                <td className="px-4 py-2 border">
                  {calculateExperience("2024-01-01")} months
                </td>
              </tr>
              <tr className="bg-white">
                <td className="px-4 py-2 border">
                ...
                <td className="px-4 py-2 border">
                  {calculateExperience("2024-02-01")} months
                </td>
              </tr>
